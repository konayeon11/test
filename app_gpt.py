...
# ✅ OpenAI API 설정
OPENAI_API_KEY = st.secrets["openai"]["api_key"]  # Streamlit Secrets에 저장된 키 사용
...
st.markdown("---")
st.caption("🧠 Powered by LightGBM + OpenAI GPT | Made with ❤️ using Streamlit")
